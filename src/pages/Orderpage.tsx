...
// تعریف نوع `OrderStats` برای نمایش اطلاعات سفارشات
...
// ✅ اصلاح نوع `StateCardProps`
interface StateCardProps {
  name: string;
  icon: React.ComponentType<LucideProps>; // 🛠 تصحیح نوع آیکون
  value: string;
  color: string;
}
